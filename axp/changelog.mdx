...
<Update label="July 28, 2026" tags={["New releases", "Improvements", "Bug fixes"]} rss={{ title: "Introducing the AXP Dashboard and AXP Edge, brand profiles, agent analytics, bot controls" }}>
