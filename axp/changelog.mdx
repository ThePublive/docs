...
<Update label="June 11, 2026" tags={["New releases", "Improvements", "Bug fixes"]} rss={{ title: "Introducing the AXP Dashboard and AXP Edge, brand profiles, agent analytics, bot controls" }}>
  ### Introducing the AXP Dashboard

  We're launching the **AXP Dashboard**, a single place to manage how AI agents discover, read, and cite your content.
  ...
  * A new **Agent Analytics** page tracks agent activity on your site.
  * The dashboard is rolling out gradually. [Contact Publive](https://axp.thepublive.com/contact) to improve your AI visibility.

  ### Introducing AXP Edge

  Also launching inside the AXP Dashboard: **AXP Edge**, an edge-rendering layer that sits in front of your existing site on your CDN and serves AI agents a clean, agent-first version of your content.
  ...
  * New **Global Rules** page in the dashboard give you control over how AXP Edge behaves across your site.
  ...
  * **Bot Override Controls:** The bot override field accepts multiple AI bots at once, so you can manage rules across several agents in a single update.

  ### Agent Analytics

  The new Agent Analytics page is live for monitoring Ai bot traffic, interactions, success rate, time-to-first-byte, top & bottom movers (percentage change in AI bot hits to a URL) etc.
</Update>
