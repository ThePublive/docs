...
<Update label="July 28, 2026" tags={["Improvements"]} rss={{ title: "AXP Edge: Global Rules and Bot Override Controls" }}>
  ### Global Rules and Bot Override Controls

  New controls give you finer-grained management over how AXP Edge behaves across your site.

  * A new **Global Rules** page lets you control how AXP Edge treats requests across your entire site from one place.
  * **Bot Override Controls:** The bot override field now accepts multiple AI bots at once, so you can manage rules across several agents in a single update.
</Update>

<Update label="July 14, 2026" tags={["New releases"]} rss={{ title: "Introducing AXP Edge" }}>
...
<Update label="June 30, 2026" tags={["New releases"]} rss={{ title: "Brand Profile and Content pages" }}>
  ### Brand Profile and Content

  Two new pages help you shape and track how AI agents see your brand.
...
<Update label="June 25, 2026" tags={["New releases"]} rss={{ title: "Introducing Agent Analytics" }}>
  ### Agent Analytics
