...
<CardGroup cols={2}>
  ...
  <Card title="Deploy on CloudFront" icon="/images/axp/logos/aws.svg" href="/axp/axp-edge/integrations/cloudfront">
    Lambda@Edge routing for an Amazon CloudFront distribution.
  </Card>
  <Card title="Deploy on Fastly" icon="/images/axp/logos/fastly.svg" href="/axp/axp-edge/integrations/fastly">
    Compute@Edge routing for a Fastly service.
  </Card>
  <Card title="Deploy on Akamai" icon="/images/axp/logos/akamai.svg" href="/axp/axp-edge/integrations/akamai">
    Property Manager rules for routing on Akamai.
  </Card>
  <Card title="Deploy on F5 XC" icon="/images/axp/logos/f5.svg" href="/axp/axp-edge/integrations/f5-xc">
...
<CardGroup cols={2}>
  ...
  <Card title="Keep AXP Edge in sync with your CDN" icon="arrows-rotate" href="/axp/axp-edge/integrations/cache-invalidation">
    Purge AXP Edge's cache alongside your own on every publish.
  </Card>
