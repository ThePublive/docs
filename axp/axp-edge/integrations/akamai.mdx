...
<Steps>
  <Step title="Create the property variables">
    ...
    Only the API key needs a value. The other three are scratch variables — Property Manager can't copy one header into another directly, so they act as a hop. You'll fill them at request time in [Step 4](#step-4-set-the-headers).
  </Step>
