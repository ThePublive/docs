...
| [POST](/api-reference/content-management/live-blogs/create-live-blog-update) | `/post/{post_id}/live-blog-update/` | Create a live blog update |
| [PATCH](/api-reference/content-management/live-blogs/update-live-blog-update) | `/post/{post_id}/live-blog-update/{id}/` | Update a live blog update |
