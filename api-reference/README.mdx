...
All API requests require HTTP Basic Auth. See [Authentication](/documentation/getting-started/authentication) for details.
...
All error responses return a descriptive status and message. See [Error Codes](/documentation/reference/error-codes) for a full reference.
