...
<Update
  ...
  rss={{ title: "AI Suite v2, Audit Logging Phase 2, Form notification improvements, Trending content API, autosave speed" }}
>
...
A new CDS endpoint returns the top 20 articles by pageviews (powered by Clickhouse).

- Available for CX to configure the trending widget per publisher
...
<Update
  label="May 8, 2026"
  tags={["New releases"]}
  rss={{ title: "Test Update" }}
>

### Test Update

This is a test changelog entry to verify the changelog layout and publishing flow.

- Item one of the test update
- Item two of the test update
