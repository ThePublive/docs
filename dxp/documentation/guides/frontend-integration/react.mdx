...
See the [Post Listing](/dxp/api-reference/content-delivery/post-listing) and [Post Details](/dxp/api-reference/content-delivery/post-details) API references for the full response shape.
