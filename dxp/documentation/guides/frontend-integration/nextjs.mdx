...
description: "Step-by-step guide to integrating the Publive CDS API with Next.js using SSR and SSG. Fetch posts, categories, and author data with full TypeScript support."
---

Build a server-rendered website powered by Publive using Next.js App Router.

## How to Set Up Publive in Next.js
...
const headers = {
  'Authorization': `Basic ${btoa(process.env.PUBLIVE_API_KEY + ':' + process.env.PUBLIVE_API_SECRET)}`
};
