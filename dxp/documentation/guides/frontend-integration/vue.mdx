...
description: "Integrate the Publive CDS API into a Vue.js application. Covers data fetching, composables, and rendering posts, categories, and author pages."
---
...
See the [Post Listing](/dxp/api-reference/content-delivery/post-listing) API for the full response shape.
...
See the [Post Details](/dxp/api-reference/content-delivery/post-details) API for the full response shape.
...
See the [Category Listing](/dxp/api-reference/content-delivery/category-listing) API.
...
See the [Navbar](/dxp/api-reference/content-delivery/navbar) API.
