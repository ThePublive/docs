...
The key server-side step is resolving the requested page from Publive with `identify`. For the SDK behavior, see [JavaScript SDK](/dxp/documentation/sdks/javascript).
