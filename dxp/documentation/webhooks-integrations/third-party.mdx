...
Use the CDS [Newsletter Groups](/dxp/api-reference/content-delivery/newsletter-groups) API to manage newsletter subscriptions:

```bash
GET /publisher/<PUBLISHER_ID>/newsletter-groups/
```
