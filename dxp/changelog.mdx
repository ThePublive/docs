---
title: "Publive DXP changelog"
description: "Track changes, new features, and updates to Publive DXP."
rss: true
---
...
<Update
  ...
  rss={{ title: "Google Discover Headline, category URL trailing slash handling, meta keyword and form email fixes, heading hierarchy fix" }}
>
...
* **Category page URLs** — category and listing page URLs now resolve consistently with or without a trailing slash, matching how articles and custom pages already behave. [Contact Us](mailto:support@thepublive.com) to configure it.
...
<Update
  ...
  rss={{ title: "Smarter cache clearing, Activity Log Form filter fix" }}
>
