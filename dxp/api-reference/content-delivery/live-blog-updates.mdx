...
<Info>
This endpoint only returns data for posts with `type: "LiveBlog"`. For other post types, use the [Post Details](/dxp/api-reference/content-delivery/post-details) endpoint.
</Info>
