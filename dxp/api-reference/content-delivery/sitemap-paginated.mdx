...
<ParamField path="date" type="string" required>
  Date partition identifier embedded in the filename (e.g. `2026-05-01`). Discover valid values from the index sitemaps: [Web Content Sitemap](/dxp/api-reference/content-delivery/sitemap-webcontent) and [Web Story Sitemap](/dxp/api-reference/content-delivery/sitemap-webstory).
</ParamField>
