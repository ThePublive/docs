...
<Info>
This endpoint only applies to posts with `type: "LiveBlog"`. For other post types, use the [Update Post](/dxp/api-reference/content-management/posts/update-post) endpoint.
</Info>
...
<ParamField body="author" type="integer">
