...
This outputs a token like `eW91cl9hcGlfa2V5OnlvdXJfYXBpX3NlY3JldA==`. Use this value in your requests.
...
curl -X GET \
  ...
  -H 'Authorization: Basic eW91cl9hcGlfa2V5OnlvdXJfYXBpX3NlY3JldA=='
```
