...
For BFSI compliance, every piece of content should go through the [approval flow](/documentation/guides/workflows/approval-flow):

```
Draft → Approval Pending → (Compliance Review) → Published
```

See the [Maker-Checker Guide](/documentation/guides/workflows/maker-checker) for detailed implementation steps.
