...
```mermaid
graph TD
    subgraph CMS ["Data Layer"]
        A["Publive CMS Content"] --> B["SDK Fetch"]
    end

    subgraph Logic ["Orchestration Layer"]
        B --> C["Layout Array"]
        C --> D["Section Object (per item)"]
        D --> E["schema_slug"]
        D --> F["Content Fields"]
    end
    ...
    subgraph Frontend ["Presentation Layer"]
        ...
        G --> H["React Component"]
        F --> I["Component Props"]
        H & I --> J["Rendered Website Section"]
    end
...
<CardGroup cols={2}>
  <Card title="Component Library" icon="blocks" horizontal>
    Explore pre-built section components
  </Card>
  <Card title="Styling Guide" icon="paintbrush" horizontal>
    Learn styling best practices for sections
  </Card>
  <Card title="SEO Optimization" icon="magnifying-glass" horizontal>
