...
```mermaid
graph LR
    A["Onboarding\n(Publive Engineer)"] -->|"Publisher ID\nAPI Key & Secret"| B["Custom App Development\n(You Own This)"]
    B -->|"Fully Built App"| C["Deployment\n(Publive Engineer)"]
    C -->|"Deployed App\nDNS Configuration"| D["Live App"]
...
<CardGroup cols={2}>
  <Card icon="newspaper" href="/guides/build-news-media" title="Build a News Website">
    Learn how to build a high-performance news/media website
  </Card>
  <Card icon="palette" href="/guides/build-brand-website" title="Build a Brand Website">
...
<CardGroup cols={2}>
  ...
  <Card icon="rocket" href="/guides/deployment" title="Deployment Guide">
