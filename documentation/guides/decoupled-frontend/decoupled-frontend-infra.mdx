...
<CardGroup cols={2}>
  <Card icon="sliders" title="Full Control">
    Complete ownership over frontend code, UI/UX, and infrastructure
  </Card>
  <Card icon="unlock" title="No Template Lock-in">
    Build custom layouts and branding without shared templates
  </Card>
  <Card icon="rocket" title="Independent Deployments">
    Deploy frontend changes without touching the CMS
  </Card>
  <Card icon="gauge-high" title="Optimized Performance">
...
<CardGroup cols={3}>
  <Card icon="newspaper" title="📰 News & Media">
    High-traffic news websites with real-time updates
  </Card>
  <Card icon="store" title="🏷️ Brand Websites">
    Marketing and corporate websites with custom designs
  </Card>
  <Card icon="book-open" title="📖 Editorial Platforms">
...
<Steps>
  ...
  <Step title="Deployment">
    ...
    <Note>
      Full CI/CD documentation available in [Deployment Guide](/documentation/guides/deployment)
    </Note>
  </Step>
  <Step title="Go Live">
...
<CardGroup cols={2}>
  <Card icon="react" title="Next.js Foundation">
    Pre-configured Next.js workspace with best practices
  </Card>
  <Card icon="plug" title="CMS Integration">
    Content Delivery SDK configured and ready to use
  </Card>
  <Card icon="download" title="Basic Fetching">
    Sample content fetching patterns and examples
  </Card>
  <Card icon="circle-check" title="Production Ready">
...
<CardGroup cols={2}>
  <Card icon="newspaper" href="/documentation/guides/decoupled-frontend/build-news-media" title="Build a News Website">
    Learn how to build a high-performance news/media website
  </Card>
  <Card icon="palette" href="/documentation/guides/decoupled-frontend/build-brand-website" title="Build a Brand Website">
...
<CardGroup cols={2}>
  ...
  <Card icon="code" title="SDK Documentation" href="/documentation/sdks/javascript">
    JavaScript SDK reference and examples
  </Card>
  <Card icon="rocket" href="/documentation/guides/deployment" title="Deployment Guide">
