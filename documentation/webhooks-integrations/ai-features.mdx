---
title: "AI Features"
description: "Auto-tagging, plagiarism detection, SEO scoring, and multilingual content recommendations — overview of Publive's built-in AI capabilities for publishers."
---
...
The AI sidebar in the editor provides inline writing and editing suggestions. As of the v2 update (May 2026):

- **Refined prompts** — suggestions are more accurate and context-aware, with improvements to how the AI interprets the surrounding article content
- **Updated sidebar UX** — the AI sidebar has an improved layout and interaction flow for a smoother editing experience
